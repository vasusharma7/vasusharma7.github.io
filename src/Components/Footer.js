    ...
    return (
      <footer className="footer" id="contact">
        ...
        <div className="section-container">
          <h2 className="footer__cta">Let's Connect</h2>
          <p className="footer__subtitle">
            Whether it's about AI security, distributed systems, or the best
            hiking trails in the Alps — I'd love to hear from you.
          </p>

          <a href={`mailto:${data.email}`} className="footer__email-link">
            <svg
              viewBox="0 0 24 24"
              width="20"
              height="20"
          ...
          <p className="footer__copyright">
            © {new Date().getFullYear()} {data.name} — Built with curiosity
          </p>
        </div>
      </footer>
    );
